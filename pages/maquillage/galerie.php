...
<head>
    <title>Galerie maquillage – Katia Bulimar</title>
    <meta name="description"
        content="Découvrez la galerie photo des maquillages réalisés par Katia Bulimar : avant/après, transformations et inspirations.">

    <link rel="canonical" href="https://www.katiabulimar.fr/maquillage/galerie.php">
    <meta charset="utf-8" />
...
<body>
    ...
    <header>
        ...
        <nav id="mainnav" class="nav container castoro-titling-regular" aria-label="Navigation principale">
            ...
            <a class="lienNav active" href="./maquillage.php">MAQUILLAGE</a>
    ...
    <main class="container-title">
        ...
        <section class="hero-page castoro-titling-regular">
            <h1 class="page-title">GALERIE – MAQUILLAGE</h1>
        </section>

        <!-- Groupe 1 : Maquillage naturel -->

        <?php
  // 1) Charger les catégories "maquillage"
  $cats = $pdo->query("
      SELECT id, name, slug
      FROM gallery_categories
      WHERE type = 'maquillage'
