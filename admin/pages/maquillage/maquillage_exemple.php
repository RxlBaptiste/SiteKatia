...
<body>
    ...
    <form action="update_maquillage_examples.php" method="post" enctype="multipart/form-data">
        <section class="card">
            <div class="field">
                <label for="img_naturel">Image maquillage naturel :</label><br>
                <input type="file" name="img_naturel" id="img_naturel" accept="image/*">
            </div>

            <div class="field" style="margin-top: 1rem;">
                <label for="img_sophistique">Image maquillage sophistiqué :</label><br>
