...
$fields = [
    'img_naturel' => [
        'name'   => 'portrait',              // valeur dans la colonne `name`
        'prefix' => 'photo_portrait_',
    ],
    'img_sophistique' => [
        'name'   => 'intimiste',
        'prefix' => 'photo_intimiste_',
    ],
];
...
foreach ($fields as $inputName => $config) {
    ...
    $sql = "
        INSERT INTO photo_examples (name, image_path)
        VALUES (:name, :path)
...
header('Location: photographie.php?updated=1');
exit;